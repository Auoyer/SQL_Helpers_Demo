...
#region 私有构造函数和方法
        ...
        {
            return ConfigurationManager.ConnectionStrings["TraditionSqlConn"].ConnectionString; 
        } 
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        { 
            SqlConnection Connection = new SqlConnection(SqlHelper2.GetConnSting()); 
            return Connection; 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                SqlParameter[] commandParameters = SqlHelper2ParameterCache.GetSpParameterSet(connectionString, spName);
        ...
        { 
            ...
            { 
                // 从缓存中加载存储过程参数 
                SqlParameter[] commandParameters = SqlHelper2ParameterCache.GetSpParameterSet(connection, spName);
        ...
        { 
            ...
            { 
                ...
                SqlParameter[] commandParameters = SqlHelper2ParameterCache.GetSpParameterSet(transaction.Connection, spName);
        ...
        /// <summary> 
        /// 枚举,标识数据库连接是由SqlHelper2提供还是由调用者提供 
        /// </summary> 
        private enum SqlConnectionOwnership 
        { 
            /// <summary>由SqlHelper2提供连接</summary> 
            Internal, 
        ...
        /// </summary> 
        /// <remarks> 
        /// 如果是SqlHelper2打开连接,当连接关闭DataReader也将关闭. 
        ...
        /// <param name="connectionOwnership">标识数据库连接对象是由调用者提供还是由SqlHelper2提供</param> 
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteDataset(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteDataset(transaction, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteReader(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteReader(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteReader(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteScalar(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteScalar(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return SqlHelper2.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return SqlHelper2.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
    ...
    /// <summary> 
    /// SqlHelper2ParameterCache提供缓存存储过程参数,并能够在运行时从存储过程中探索参数. 
    /// </summary> 
    public sealed class SqlHelper2ParameterCache 
    { 
        #region 私有方法,字段,构造函数 
        // 私有构造函数,妨止类被实例化. 
        private SqlHelper2ParameterCache() { }
